...
<html>
	<head>
		...
		<link href="boots/css/sb-admin-2.min.css" rel="stylesheet">
	...
	<body class="is-preload">
		...
		<!-- Wrapper -->
			...
			<div id="wrapper" style="padding-top:0;transform:scale(1.0,1.0);">
				...
				<!-- Main -->
				<div id="main" style="padding-top:7em;">
		...
		<!-- Scripts -->
			...
			<script src="{{asset('phantom_resources/assets/js/include_all_subjects.js')}}"></script>
			 ...
			 <script src="{{asset('boots/vendor/jquery/jquery.min.js')}}"></script>
			 <script src="{{asset('boots/vendor/bootstrap/js/bootstrap.bundle.min.js')}}"></script>
		 
			 <!-- Core plugin JavaScript-->
			 <script src="{{asset('boots/vendor/jquery-easing/jquery.easing.min.js')}}"></script>
		 
			 <!-- Custom scripts for all pages-->
			 <script src="{{asset('boots/js/sb-admin-2.min.js')}}"></script>
		 
			 <!-- Page level plugins -->
			 <script src="{{asset('boots/vendor/chart.js/Chart.min.js')}}"></script>
		 
			 <!-- Page level custom scripts -->
			 <script src="{{asset('boots/js/demo/chart-area-demo.js')}}"></script>
			 <script src="{{asset('boots/js/demo/chart-pie-demo.js')}}"></script>
